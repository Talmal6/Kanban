...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return ts.SetTaskDueDate(email, boardName, taskId, dueDate);
        }
        ...
        {
            return ts.SetTaskTitle(email, boardName, taskId, title);
        }
        ...
        {
            return ts.SetTaskDescription(email, boardName, taskId, description);
        }
        ...
        {
            return ts.AdvanceTask(email, boardName, taskId);
        }
        ...
        {
            return bs.CreateBoard(email, name);
        }


        /// <summary>
        /// This method מs a board.
        /// </summary>
        ...
        {
            return bs.DeleteBoard(email, name);
        }
        ...
        {
            return us.GetInProgressTasks(email);
        }
        ...
        {
            return ts.AssignTask(email, boardName, taskID, emailAssignee);
        }
        ...
        public string DeleteData()
        {
            ...
            ts.ClearAllTasks(ref response);
            bs.ClearAllBroards(ref response);
            us.ClearAllUsers(ref response);
            return response.ToJson();
        }
    }
}